...
public abstract class STPSecurityHelper {
    ...
    public static SSLContext getSSLContextForCertificate(final InputStream certificateInputStream,
            final String certificatePassword) throws STPException {
        try {
            final CertificateFactory certificateFactory = CertificateFactory.getInstance(CERTIFICATE_TYPE);
            final X509Certificate x509Certificate = (X509Certificate) certificateFactory
            ...
            TrustManager[] trustManagers = new TrustManager[] { new X509TrustManager() {
                ...
                public void checkServerTrusted(final X509Certificate[] x509Certificates, final String authType)
                    ...
                    if (!Arrays.equals(x509Certificates[0].getPublicKey().getEncoded(),
    ...
    public static SSLContext getSSLContextForKeyStore(final InputStream keyStoreInputStream,
            final String keyStorePassword) throws STPException {
        try {
            ...
            return sslContext;
        } catch (final IOException | KeyStoreException | UnrecoverableKeyException | NoSuchAlgorithmException
