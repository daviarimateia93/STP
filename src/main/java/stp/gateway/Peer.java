...
public class Peer extends STPObject {
    ...
    public void start(final String host, final int port, final InputStream certificateInputStream,
        ...
        if (!started) {
            ...
            try {
                if (certificateInputStream != null) {
                    final SSLSocketFactory sslSocketFactory = STPSecurityHelper
                            .getSSLContextForCertificate(certificateInputStream, certificatePassword)
                            .getSocketFactory();
